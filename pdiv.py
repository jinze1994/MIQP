...
if __name__ == '__main__':
  ...
  l3,=ax1.plot(greedydiv,greedypd,label='greedy-p@'+str(k),color='r')
  l4,=ax1.plot(gurobidiv,gurobipd,label='gurobi-p@'+str(k),color='g') 
  ...
  ax1.set_xlabel('div(clo)')
  
  #my_xticks=np.arange(0,1,0.1)
